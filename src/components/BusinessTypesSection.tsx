...
export function BusinessTypesSection() {
  const t = useTranslations("businessTypesSection");
        ...
        <Reveal className="grid grid-cols-7 gap-3 max-lg:grid-cols-2 max-md:grid-cols-1">
          {businessTypes.map((business) => {
            ...
            >
              ...
              <h3 className="font-display text-lg font-black leading-tight text-dev-black">{business[locale].title}</h3>
              <p className="mt-2 text-[13px] leading-relaxed text-dev-gray">{business[locale].copy}</p>
            </article>
            );
          })}
        </Reveal>
